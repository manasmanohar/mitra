            ...
            <form class="bg-blue-100 shadow-md rounded px-8 pt-6 pb-8 mb-1">
                ...
                <div class="relative mb-3 xl:w-96">
                    ...
                    <input
                        datepicker
                        type="date"
                        class="rounded-lg bg-gray-50 border border-gray-300 text-gray-900 sm:text-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
